...
{
	public partial class WvpFieldGuid : WvpFieldBase, IDisposable
	{
		...
		private DotNetObjectReference<WvpFieldGuid> _objectReference;
		...
		protected override async Task OnParametersSetAsync()
		{
			...
			if (_originalFieldId != FieldId)
			{
				...
				_domElementId = "wvp-field-guid-" + FieldId;
			}
