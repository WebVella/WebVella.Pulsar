...
{
	public partial class WvpFieldTemplatedList<ValueItemType> : WvpFieldBase, IDisposable 
	{
		...
		[Parameter] public bool ShowSelectedItemOnly { get; set; }
		[Parameter] public bool ShowSelectedItemOnTop { get; set; }
		...
		private DotNetObjectReference<WvpFieldTemplatedList<ValueItemType>> _objectReference;
