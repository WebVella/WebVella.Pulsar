...
{
	public partial class WvpFieldImage : WvpFieldBase, IDisposable
	{
		...
		private DotNetObjectReference<WvpFieldImage> _objectReference;
		...
		protected override async Task OnParametersSetAsync()
		{
			...
			if (_originalFieldId != FieldId)
			{
				...
				_domElementId = "wvp-field-image-" + FieldId;
			}
