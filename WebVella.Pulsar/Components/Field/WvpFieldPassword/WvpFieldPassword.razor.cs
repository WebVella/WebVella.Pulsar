...
{
	public partial class WvpFieldPassword : WvpFieldBase, IDisposable
	{
		...
		private DotNetObjectReference<WvpFieldPassword> _objectReference;
		...
		protected override async Task OnParametersSetAsync()
		{
			...
			if (_originalFieldId != FieldId)
			{
				...
				_domElementId = "wvp-field-password-" + FieldId;
			}
